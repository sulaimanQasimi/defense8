...
trait GunCardField
{
    ...
    protected function gun_render($context)
    {
        return Str::of($context)
            ...
            ->replace($this->gun_translated_field("register_date"), ($this->employee->gun_card?->register_date) ? verta($this->employee->gun_card?->register_date)->format("Y/m/d") : "")
            ->replace($this->gun_translated_field("expire_date"), ($this->employee->gun_card?->expire_date) ? verta($this->employee->gun_card?->expire_date)->format("Y/m/d") : "")
        ;
    }
}
