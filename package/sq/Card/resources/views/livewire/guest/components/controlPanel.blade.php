<div class="grid grid-cols-2 gap-x-2 gap-y-3">
    ...
    <x-sqcard::form.dimention-slider label="QR code Dimentions" xModel="attr.qrcode.x" yModel="attr.qrcode.y" zModel="attr.qrcode.size" xMax="270" yMax="270" zMax="250"  />

    {{-- Image Dimentions --}}
    <x-sqcard::form.dimention-slider label="Image Dimentions" xModel="attr.profile.x" yModel="attr.profile.y" zModel="attr.profile.size" xMax="270" yMax="270" zMax="250"  />

    {{-- Ministry Logo Dimentions --}}
    <x-sqcard::form.dimention-slider label="Ministry Logo Dimentions" xModel="attr.ministry.x" yModel="attr.ministry.y" zModel="attr.ministry.size" xMax="270" yMax="270" zMax="250"  />

    {{-- Ministry Logo Dimentions --}}
    <x-sqcard::form.dimention-slider label="Government Logo Dimentions" xModel="attr.government.x" yModel="attr.government.y" zModel="attr.government.size" xMax="270" yMax="270" zMax="250"  />
