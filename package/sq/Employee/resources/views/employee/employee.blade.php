<div class="mt-4" dir="rtl">
  ...
  >
  <div
  class="rightside bg-gray-100 p-4 rounded-lg border border-white shadow-md"
>
                ...
                <thead class="">
                    ...
                    <tr class="border border-gray-600">
                        ...
                        <td class="px-4 py-1  text-xl">
                            ...
                            <p class="font-medium leading-none text-gray-700 mr-2 text-xl">
                                {{ $employee->current_id_card ? verta($employee->current_id_card?->card_perform)->format('Y/m/d') : '' }}
                            </p>
                        </td>
                    </tr>
                    <tr class="border border-gray-600">
                        ...
                        <td class="px-4  py-1 text-xl">
                            ...
                            <p class="font-medium leading-none text-gray-700 mr-2 text-xl">
                                ...
                                {{ $employee->current_id_card ? verta($employee->current_id_card?->card_expired_date)->format('Y/m/d') : '' }}
                            </p>
                        </td>
                    </tr>
                    <tr class="border border-gray-600">
        ...
        <div
        class="text-right bg-gradient-to-r from-yellow-200 to-yellow-400 p-4 rounded-lg shadow-md"
      >            <div class="text-red-500 font-bold">شرایط:</div>
        ...
        <div class="leftside bg-white rounded-lg shadow-md">
