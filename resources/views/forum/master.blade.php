...
<head>
    ...
    <script src="{{ asset('fourm/feather.js') }}"></script>
    <script src="{{ asset('fourm/feather.min.js') }}"></script>
    <!-- Vue (https://github.com/vuejs/vue) -->
    @if (config('app.debug'))
        <script src="{{ asset('fourm/vue.js')}}"></script>
    @else
        <script src="{{ asset('fourm/vue@2.6.14')}}"></script>
    @endif
    ...
    <link rel="stylesheet" href="{{asset('fourm/classic.min.css')}}">
    <script src="{{asset('fourm/pickr.min.js')}}"></script>

    <!-- Sortable (https://github.com/SortableJS/Sortable) -->
    <script src="{{asset('fourm/Sortable.min.js')}}></script>
    <!-- Vue.Draggable (https://github.com/SortableJS/Vue.Draggable) -->
    <script src="{{asset('fourm/Vue.Draggable-master/dist/vuedraggable.umd.js')}}"></script>
</head>
