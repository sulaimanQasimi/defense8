<div dir="rtl">
    ...
    <div id="printable" class="pt-6 pb-3" wire:ignore x-data="{
        ...
        uploading: false,
        progress: 0,
        gov: $wire.entangle('gov').live,
        color: $wire.entangle('color').live,
        govSize: $wire.entangle('gov_size').live,
        qrX: $wire.entangle('qr_x').live,
        qrY: $wire.entangle('qr_y').live,
        proX: $wire.entangle('pro_x').live,
        proY: $wire.entangle('pro_y'),
        infoSize: $wire.entangle('info_size').live,
        ...
        <div class="grid grid-cols-4 gap-x-6">
            <div class="bg-white bg-opacity-50 rounded-lg shadow-lg p-6 relative overflow-hidden row-span-2">
                ...
                <div class="my-2">
                    ...
                    <label class="slider">
                        <input type="range" class="level" x-model="infoSize" max="15">
                    </label>
                </div>
            ...
            <div class="col-span-3 flex  justify-items-end">
                <div class="bg-white h-[2.13in] w-[3.34in] block  rounded-xl relative ">
                    ...
                    <div id="qrcode" style="width:30px; height:30px;position: absolute;;"
