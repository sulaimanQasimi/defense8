...
<div class="block">@lang('Start Date'):<span>{{($cardInfo?->main_card->card_perform)?verta($cardInfo?->main_card->card_perform)->format("Y/m/d"):""}}</span></div>
<div class="block">@lang('Expire Date'):<span>{{($cardInfo?->main_card->card_expired_date)?verta($cardInfo?->main_card->card_expired_date)->format("Y/m/d"):""}}</span></div>
