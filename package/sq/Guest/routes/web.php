...
Route::prefix("guest")
    ...
    ->group(function () {
        ...
        Route::get('/patients/{patient}/deactivate', [QRCodeGenerateController::class, 'deactivate'])->name('guest.patients.deactivate');
        Route::get('/patients/{patient}/exit', [QRCodeGenerateController::class, 'exitPatient'])->name('guest.patients.exit');
        //
