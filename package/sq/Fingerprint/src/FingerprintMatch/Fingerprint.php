<?php
namespace Sq\Fingerprint\FingerprintMatch;

use Sq\Fingerprint\FingerprintMatch\Exceptions\NotInstalledException;
use Sq\Fingerprint\FingerprintMatch\Exceptions\NotLinuxException;
