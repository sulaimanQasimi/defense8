...
CKEDITOR.editorConfig = function (config) {
    ...
    config.line_height =
        "0.1em;0.2em;0.3em;0.4em;0.5em;0.6em;0.7em;0.8em;0.9em;1em;1.1em;1.2em;1.3em;1.4em;1.5em";
    config.toolbar = [
        {
            name: "basicstyles",
            items: [
    ...
    config.font_names =
        "nasim/persian-font;nazanin/nazanin-font;ihsan-bv/ihsan-bv;ihsan-likedood/ihsan-likedood;ihsan-MV/ihsan-MV;ihsan-NV/ihsan-NV;" +
        config.font_names;
};
