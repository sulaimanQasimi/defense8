...
<div>
    <div class="flex items-center justify-center w-full">
        <label for="gov-logo-file-upload"
            ...
            <input id="gov-logo-file-upload" type="file" class="hidden" wire:model.live="attr.government.path" />
        </label>
    </div>
</div>
    ...
    <div class="flex items-center justify-center w-full">
        <label for="ministry-logo-file-upload"
            ...
            <input id="ministry-logo-file-upload" type="file" class="hidden"
                wire:model.live="attr.ministry.path" />
        </label>
    </div>
</div>
    ...
    <div class="flex items-center justify-center w-full">
        <label for="card-back-logo-file-upload"
            ...
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">@lang('Back of Card Background')</p>
            </div>
    ...
    <div class="flex items-center justify-center w-full">
        <label for="card-signature-file-upload"
            ...
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">@lang('Minister Signature')</p>
            </div>
            <input id="card-signature-file-upload" type="file" class="hidden"
                wire:model.live="attr.signature.path" />
        </label>
    </div>
</div>
