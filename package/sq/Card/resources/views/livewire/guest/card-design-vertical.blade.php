        ...
        <div class="col-span-2">
            <div class="grid grid-cols-2">
                <div class="bg-white max-h-[3.44in] h-[3.44in] w-[2.2in] block  rounded-xl relative  bg-cover bg-center bg-local bg-no-repeat"
                    :style="{ 'background-image': 'url('+'{{ $cardFrame->ip_address }}/storage/' + attr.content.background + ')' }">
                    <div class="h-[3rem] border-t rounded-t-xl"
                        ...
                        <img :src="'{{ $cardFrame->ip_address }}/storage/' + attr.government.path" class="absolute rounded-full"
                            :style="{
                        ...
                        <img :src="'{{ $cardFrame->ip_address }}/storage/' + attr.ministry.path" class="absolute rounded-full"
                            :style="{
